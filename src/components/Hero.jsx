  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center px-6 pt-20 relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-32 left-16 w-40 h-40 bg-gradient-to-br from-blue-500/10 to-green-500/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-24 right-20 w-48 h-48 bg-gradient-to-br from-green-500/10 to-blue-500/10 rounded-full blur-3xl"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-6xl md:text-7xl font-bold text-white font-inter leading-tight">
                Hi, I'm{' '}
                <span className="bg-gradient-to-r from-blue-400 via-green-400 to-cyan-400 bg-clip-text text-transparent animate-gradient-x">
                  Sajiya
                </span>
              </h1>
              
              {/* Typewriter Effect */}
              <div className="flex items-center gap-2 text-3xl md:text-4xl font-semibold text-gray-300">
                <span className="text-blue-400 font-mono">{'>'}</span>
                <span>A passionate </span>
                <span className="bg-gradient-to-r from-cyan-400 to-green-400 bg-clip-text text-transparent min-w-[300px]">
                  {currentText}
            ...
            {/* Description */}
            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl font-inter">
            ...
            <div className="flex items-center gap-4 pt-8">
              ...
              {[
                ...
                <a
                  key={index}
                  href="#"
                  className="w-12 h-12 bg-slate-800 backdrop-blur-sm border border-slate-700 rounded-lg flex items-center justify-center text-gray-400 hover:text-white hover:border-green-400 hover:bg-slate-700 transition-all duration-300 cursor-hover group"
                >
